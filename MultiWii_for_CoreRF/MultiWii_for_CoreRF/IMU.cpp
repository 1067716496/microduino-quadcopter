...
uint8_t getEstimatedAltitude(){
  ...
  //alt.EstAlt = (alt.EstAlt * 6 + BaroAlt * 2) >> 3; // additional LPF to reduce baro noise (faster by 30 碌s)

  tmpEstAlt = (tmpEstAlt * 6 + BaroAlt * 2) >> 3; // additional LPF to reduce baro noise (faster by 30 碌s)
